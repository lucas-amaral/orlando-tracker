  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS park_prices (
        id SERIAL PRIMARY KEY,
        checked_at TIMESTAMPTZ DEFAULT NOW(),
        park_brand TEXT,       -- 'disney' or 'universal'
        park_names TEXT[],     -- e.g. ARRAY['Magic Kingdom','EPCOT',...]
        ticket_type TEXT,      -- 'single' or 'promotion'
        promotion_name TEXT,   -- e.g. '4-Park Magic Ticket'
        days INTEGER,
        price_usd NUMERIC(10,2),
        price_brl NUMERIC(10,2),
        num_tickets INTEGER,
